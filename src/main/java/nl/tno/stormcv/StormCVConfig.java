...
public class StormCVConfig extends Config {
    ...
    public StormCVConfig() {
        ...
        put(Config.TOPOLOGY_EXECUTOR_RECEIVE_BUFFER_SIZE, 2); // sets the maximum number of messages to batch before sending them to executers
        put(Config.TOPOLOGY_EXECUTOR_SEND_BUFFER_SIZE, 2); // sets the maximum number of messages to batch before sending them to executers
        ...
        //put(STORMCV_SPOUT_FAULTTOLERANT, false);
