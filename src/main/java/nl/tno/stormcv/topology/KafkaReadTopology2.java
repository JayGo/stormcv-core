...
import nl.tno.stormcv.spout.MatImageSpout;
...
public class KafkaReadTopology2 {
	...
	public static void main(String[] args) throws ParseException, IOException {
		...
		//urls.add("http://10.8.8.151:63000/");
...
//        spoutConf.maxOffsetBehind=64;
		...
		/**
		 * create the topologycreate the topology
		 **/
		//create the topology
...
//        builder.setBolt(
//				"streamer0",
//				new SingleInputBolt(new SingleRTMPWriterOp().appName(topic).frameRate(25)), 1)
//				.shuffleGrouping("scale");
