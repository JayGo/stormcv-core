...
public class XugglerStreamReader extends MediaListenerAdapter implements Runnable {
    ...
    public XugglerStreamReader(String streamId, String streamLocation, String imageType, int frameSkip, int groupSize, int sleepTime, LinkedBlockingQueue<Frame> frameQueue) {
