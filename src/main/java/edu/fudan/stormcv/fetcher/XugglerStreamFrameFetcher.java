...
import edu.fudan.stormcv.util.reader.XugglerStreamReader;
...
/**
 * A {@link IFetcher} implementation that reads video streams (either live or not). The XugglerStreamFrameFetcher is initialized
 ...
 * <p>
 * It is possible to provide an additional sleep which is enforced after each emitted frame. This sleep can be used to throttle the XugglerStreamFrameFetcher
 ...
 */
public class XugglerStreamFrameFetcher implements IFetcher<CVParticle> {
    ...
    protected Map<String, XugglerStreamReader> streamReaders;
    ...
    public XugglerStreamFrameFetcher(List<String> locations) {
        this.locations = locations;
    }

    public XugglerStreamFrameFetcher frameSkip(int skip) {
        this.frameSkip = skip;
        return this;
    }
     ...
     * @return
     */
    public XugglerStreamFrameFetcher groupSize(int size) {
        this.groupSize = size;
        return this;
    }

    public XugglerStreamFrameFetcher sleep(int ms) {
        this.sleepTime = ms;
        return this;
    }
     ...
     * @return
     */
    public XugglerStreamFrameFetcher groupOfFramesOutput(int nrFrames) {
    ...
    public void activate() {
        ...
        streamReaders = new HashMap<String, XugglerStreamReader>();
        for (String location : locations) {
            ...
            XugglerStreamReader reader = new XugglerStreamReader(streamId, location, imageType, frameSkip, groupSize, sleepTime, frameQueue);
