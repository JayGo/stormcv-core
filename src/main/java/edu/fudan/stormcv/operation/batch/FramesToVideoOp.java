...
import edu.fudan.stormcv.model.serializer.VideoChunkSerializer;
import edu.fudan.stormcv.operation.single.VideoToFramesOp;
import edu.fudan.stormcv.util.connector.ConnectorHolder;
import edu.fudan.stormcv.util.connector.FileConnector;
import edu.fudan.stormcv.util.writer.XugglerStreamWriter;
...
public class FramesToVideoOp implements IBatchOperation<CVParticle> {
    ...
    private ConcurrentHashMap<String, XugglerStreamWriter> writers;
